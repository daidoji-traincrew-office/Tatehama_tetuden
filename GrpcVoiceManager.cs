...
{
    public class GrpcVoiceManager : IDisposable
    {
        ...
        public GrpcVoiceManager()
        {
            // コンストラクタでは何もしない（通話開始時に接続する）
        }
